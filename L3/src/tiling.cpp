...
namespace L3 {
    ...
    //dst = oprand2
    Tile_math_same_2::Tile_math_same_2(std::string op) {
    ...
    //dst = oprand1
    Tile_math_same_1::Tile_math_same_1(string op) {
        this->root = new TileNode();
        root->id = 0;
        root->tile_type |= TileNodeTypeVariable;
        root->op = new Operation(op);
    ...
    //dst != oprand1 != oprand2
    Tile_math_basic::Tile_math_basic(string op) {
        this->root = new TileNode();
        root->id = 0;
        root->tile_type |= TileNodeTypeVariable;
        root->op = new Operation(op);
    ...
    //oprand1 = oprand2
    Tile_math_same_12::Tile_math_same_12(std::string op) {
        this->root = new TileNode();
        root->id = 0;
        root->tile_type |= TileNodeTypeVariable;
        root->op = new Operation(op);
